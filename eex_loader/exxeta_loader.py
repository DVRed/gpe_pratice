...
from config import ANALYTICS_BASE_DB_CONFIG, DBConfigInstance
from eex_parser import Eex
...
class DBLoaderProducts(DBLoaderDeliveryPointType):
    ...
    def insert_item(
        ...
        Args:
            ...
            in_comment: комментарий, включающий часы поставки и тип периода поставки. Например:
        ...
        value = {
            ...
            'comment': in_comment if in_market == 'Natural Gas' else 'Incorrect delivery period'
        }
