...
Описание:
Этот файл принимает на вход переменные, необходимые для валидации и
загрузки в таблицу curves БД analytics_base.
Входные данные:
id_curve: id записи в curves_dict
date: дата в формате объекта библиотеки datetime
value: значение в формате np.float64
Выходные данные:
Нет
"""
