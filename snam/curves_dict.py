...
Описание:
Этот файл производит валидацию и добавление записей в таблицу
curves_dict БД analytics_base.
Входные данные:
sector: название сектора
time_period: временной интервал данных (1MIN,1DAY)
id_curve: id записи в таблице curves_dict
Выходные данные:
id_curve: id записи в таблицах
"""
